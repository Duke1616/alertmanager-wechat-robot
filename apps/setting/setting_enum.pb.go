...
// ParseSETTING_TYPEFromString Parse SETTING_TYPE from string
func ParseSETTING_TYPEFromString(str string) (SETTING_TYPE, error) {
	key := strings.Trim(string(str), `"`)
	v, ok := SETTING_TYPE_value[strings.ToUpper(key)]
	if !ok {
		return 0, fmt.Errorf("unknown SETTING_TYPE: %s", str)
	}

	return SETTING_TYPE(v), nil
}

// Equal type compare
func (t SETTING_TYPE) Equal(target SETTING_TYPE) bool {
	return t == target
}

// IsIn todo
func (t SETTING_TYPE) IsIn(targets ...SETTING_TYPE) bool {
...
// MarshalJSON todo
func (t SETTING_TYPE) MarshalJSON() ([]byte, error) {
...
// UnmarshalJSON todo
func (t *SETTING_TYPE) UnmarshalJSON(b []byte) error {
	ins, err := ParseSETTING_TYPEFromString(string(b))
	if err != nil {
		return err
	}
	*t = ins
